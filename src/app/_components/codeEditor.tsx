...
export default function CodeEditor ({ socket, codeFromSocket, langFromSocket, filePathFromSocket, outputFromSocket, errOutputFromSocket, errFromSocket, roomId, isLoading, user }: PropTypes): JSX.Element {
